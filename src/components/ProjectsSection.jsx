...
const projects = [
  ...
  },
  {
    ...
    description:
      "Interactive dashboard for code review analytics, visualizing code quality metrics and team performance.",
  ...
  },
  {
    ...
    description:
      "Coffee shop mobile application with a sleek design, allowing users to browse the menu, place orders, and make payments.",
